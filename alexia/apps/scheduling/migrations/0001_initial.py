    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organization', models.ForeignKey(on_delete=models.CASCADE, related_name='availabilities', verbose_name='organization', to='organization.Organization')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('availability', models.ForeignKey(on_delete=models.PROTECT, verbose_name='availability', to='scheduling.Availability')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organizer', models.ForeignKey(on_delete=models.PROTECT, related_name='events', verbose_name='organizer', to='organization.Organization')),
                ('participants', models.ManyToManyField(related_name='participates', verbose_name='participants', to='organization.Organization')),
                ('pricegroup', models.ForeignKey(on_delete=models.SET_NULL, related_name='events', verbose_name='pricegroup', to='billing.PriceGroup')),
            ],
            options={
                'ordering': ('-starts_at',),
                'verbose_name': 'event',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organization', models.ForeignKey(on_delete=models.CASCADE, verbose_name='organization', to='organization.Organization')),
            ],
            options={
                'ordering': ('organization', 'name'),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location', models.ForeignKey(on_delete=models.CASCADE, verbose_name='location', to='organization.Location')),
                ('organization', models.ForeignKey(on_delete=models.CASCADE, verbose_name='organization', to='organization.Organization')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='event',
            field=models.ForeignKey(on_delete=models.CASCADE, related_name='bartender_availabilities', verbose_name='event', to='scheduling.Event'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='bartenderavailability',
            name='user',
            field=models.ForeignKey(on_delete=models.CASCADE, related_name='bartender_availability_set', verbose_name='bartender', to=settings.AUTH_USER_MODEL),
            preserve_default=True,
        ),
        migrations.AlterUniqueTogether(
            name='bartenderavailability',
