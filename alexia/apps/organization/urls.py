...
urlpatterns = [
    ...
    url(r'^membership/add/$', views.MembershipCreateView.as_view(), name='new-membership'),
    url(r'^membership/add/(?P<username>[ms][0-9]{7})/$', views.UserCreateView.as_view(), name='add-membership'),
    url(r'^membership/(?P<pk>[0-9]+)/show/$', views.MembershipDetailView.as_view(), name='membership'),
    url(r'^membership/(?P<pk>[0-9]+)/edit/$', views.MembershipUpdate.as_view(), name='edit-membership'),
